...
try:
    ...
    print(bulk_json_data("people.json", "employees100", "people100"))
   # response = helpers.bulk(elastic, bulk_json_data("people.json", "employees100", "people100"))
...
actions = [
    {
        ...
        "doc_type" : "people", # document _type
...
actions = [
    ...
    for doc in range(2000) # use 'for' loop to insert 100 documents
]
...
try:
    ...
    print(actions)
    response = ""
    response = helpers.bulk(elastic, actions, index='contents', doc_type='title')
